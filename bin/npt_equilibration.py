...
"""Run NPT equilibration (gmx grompp -r + gmx mdrun).

Converted from nf-core/moleculardynamics modules/local/run_npt_equilibration.nf.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Run GROMACS NPT equilibration")
    parser.add_argument("--input-gro", required=True, help="NVT-equilibrated .gro structure")
    parser.add_argument("--input-top", required=True, help="Topology (.top) file")
    parser.add_argument("--mdp", required=True, help="NPT equilibration .mdp file")
    parser.add_argument("--output-gro", required=True, help="Output NPT .gro file")
